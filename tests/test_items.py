...
def test_delete_not_exist_item(client,admin_login):
    ...
    response = client.delete("/api/v1/items/delete/",params={"item_id":898},headers=admin_login)
    assert response.status_code == 404
...
def test_delete_item(client,admin_login):
    ...
    response = client.delete("/api/v1/items/delete/",params={"item_id":created_item_id},headers=admin_login)
    assert response.status_code == 200
